...
struct BillTotalField: View {
    ...
    var body: some View {
        TextField("Bill Total", text: $totalAmountStr) .font(.largeTitle)
...
struct BillTotalField_Previews: PreviewProvider {
    @State static var previewTotalAmountStr: String = ""
    static var previews: some View {
        BillTotalField(totalAmountStr: $previewTotalAmountStr)
    }
}
